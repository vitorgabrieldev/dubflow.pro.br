...
export const getAll = (options, cancelToken) => {
	...
	if( options.hasOwnProperty("service_category_id") )
	{
		params.push(`service_category_id=${options.service_category_id}`);
	}

	if( options.hasOwnProperty("service_type_id") )
	{
		params.push(`service_type_id=${options.service_type_id}`);
	}
