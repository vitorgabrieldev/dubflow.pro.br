				...
				<Form layout="vertical">
					<Tabs defaultActiveKey="general">
						<Tabs.TabPane forceRender tab="Informações gerais" key="general">
							...
							<Row gutter={16}>
								{this.renderTextField("Aceite dos termos de uso", this.formatDateTime(item?.accepted_term_of_users_at))}
								{this.renderTextField("Aceite da política de privacidade", this.formatDateTime(item?.accepted_policy_privacy_at))}
							</Row>
							...
							<Row gutter={16}>
								{this.renderBooleanField("Ativo", !!item?.is_active)}
							</Row>
						</Tabs.TabPane>
