			...
			<Modal
				...
				<div className="filter-group">
					...
					<div className="filter-group-filters" style={{paddingBottom: 5}}>
						<div className="filter-group-radios">
							<div className="filter-group-radio">
								<Radio onChange={() => this.setFilter("user_type", null)} checked={filters.user_type === null}>Todos os tipos</Radio>
							</div>
							<div className="filter-group-radio">
								<Radio onChange={() => this.setFilter("user_type", "Todos")} checked={filters.user_type === "Todos"}>Todos</Radio>
							</div>
							<div className="filter-group-radio">
								<Radio onChange={() => this.setFilter("user_type", "Cliente")} checked={filters.user_type === "Cliente"}>Cliente</Radio>
							</div>
							<div className="filter-group-radio">
								<Radio onChange={() => this.setFilter("user_type", "Despachante")} checked={filters.user_type === "Despachante"}>Despachante</Radio>
							</div>
						</div>
					</div>
				</div>
