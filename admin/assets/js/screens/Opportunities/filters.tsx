			...
			<Modal
				...
				<div className="filter-group">
					...
					<div className="filter-group-filters" style={{paddingBottom: 5}}>
						<div className="filter-group-radios">
							...
							<div className="filter-group-radio"><Radio onChange={() => this.setFilter("visibility", "external")} checked={filters.visibility === "external"}>Externas</Radio></div>
				...
				<div className="filter-group">
					...
					<div className="filter-group-filters">
						<Form.Item label="ID da comunidade"><Input value={filters.organization_id || ""} onChange={(e) => this.setFilter("organization_id", e.target.value || null)} /></Form.Item>
						<Form.Item label="UUID do criador"><Input value={filters.created_by_user_uuid || ""} onChange={(e) => this.setFilter("created_by_user_uuid", e.target.value || null)} /></Form.Item>
					</div>
				</div>
				<div className="filter-group">
				...
				<div className="filter-group">
					<div className="filter-group-title"><h3>Data de início da oportunidade</h3></div>
					<div className="filter-group-filters" style={{paddingBottom: 0}}>
						<Form.Item>
							<DatePicker.RangePicker format="DD/MM/YYYY" value={filters.starts_at} onChange={(date) => this.setFilter("starts_at", date ?? null)} disabledDate={(currentDate) => currentDate.isAfter(moment().add(5, "year"), "day")} />
						</Form.Item>
					</div>
				</div>
				<div className="filter-group">
